  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="cyber-panel max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-2xl cyber-text mb-2">How to Play BidTacToe</DialogTitle>
          <DialogDescription>
        ...
        <div className="space-y-4 my-4">
          ...
          <div>
            <h3 className="font-bold text-lg mb-2">Gameplay Rules</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <div>
            <h3 className="font-bold text-lg mb-2">Winning Conditions</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li><span className="text-cyber-purple font-medium">Standard Win:</span> Get three of your marks in a row (horizontally, vertically, or diagonally)</li>
              <li><span className="text-cyber-blue font-medium">Economic Win:</span> Have more money than your opponent when the board fills</li>
              <li><span className="text-cyber-green font-medium">Bankruptcy:</span> If your opponent can't place a bid (has $0), you win</li>
            </ul>
          </div>
